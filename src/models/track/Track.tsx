...
import waterUrl from '../../assets/sounds/water.mp3'
...
export function Track(): JSX.Element {
  ...
  const { nodes: n, materials: m } = useGLTF(trackDracoUrl) as TrackGLTF
    ...
    <group dispose={null}>
      ...
      <group ref={level}>
        ...
        <mesh geometry={n.water.geometry}>
          ...
          <ToggledPositionalAudio url={waterUrl} loop autoplay distance={10} />
        </mesh>
      </group>
      <group ref={birds}>
